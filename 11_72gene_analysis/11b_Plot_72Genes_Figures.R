# Two Figures for 72 Validated GmJAG1 Targets
...
annot <- read_csv(file.path(out_dir, "TableS_72Genes_AllTargets.csv"),
                  show_col_types = FALSE)

tp_fc <- read_csv(file.path(out_dir, "72genes_TP1_FC.csv"),
                  show_col_types = FALSE)
...
p_combined <- p_bar + p_dot +
  ...
  plot_annotation(
    title = "72 Validated GmJAG1 Targets: Expression Change at TP1 and Leaf Shape Correlation",
...
ggsave(file.path(out_dir, "Fig_72Genes_BarDot_TP1.png"),
       p_combined, width = 12, height = 16, dpi = 300)

cat("Saved: Fig_72Genes_BarDot_TP1.pdf/png\n")
...
ht <- Heatmap(mat,
              ...
              column_title = "72 Validated GmJAG1 Targets: Temporal Expression and Leaf Shape Correlation",
              column_title_gp = gpar(fontsize = 11, fontface = "bold")
)

# Save PNG only
png(file.path(out_dir, "Fig_72Genes_ComplexHeatmap.png"),
...
cat("Saved: Fig_72Genes_ComplexHeatmap.pdf/png\n")
